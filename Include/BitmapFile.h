...
//	// JPEG(.jpg) File Utilities: See CompressedFile.cpp
//	int ReadJPEG(char *name);
//	int WriteJPEG(char *name, int Quality = 75, int Samples = 4);
//
//	// Portable Network Graphics(.png) File Utilities: See CompressedFile.cpp
//	int ReadPNG(char *name);
//	int WritePNG(char *name);

	// Pixel Operations
	Pixel GetPixel(int x, int y);
	void GetPixelLinear(double x, double y, double &r, double &g, double &b);
	void GetPixelLinear(double x, double y, double &r, double &g, double &b, double &a);
