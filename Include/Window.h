...
public:
	...
	virtual void Setup(Window &Parent, int x, int y, int width, int height, BOOL Visible = TRUE)
	{ Setup(&Parent, x, y, width, height, Visible, NULL, TRUE); }
	virtual void Setup(Window &Parent, int x, int y, int width, int height, BOOL Visible, char *cName, bool AdjRect = TRUE)
