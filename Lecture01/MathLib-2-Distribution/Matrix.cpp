...
void matrix::MakeRotation(double alpha, const vector &v)
{
	...
	m[0][0] = temp[0]* temp[0] * ( 1 - cos( alpha * (PI/180.0) ) ) + cos( alpha * (PI/180.0) );
	m[0][1] = (temp[0] * temp[1]) * ( 1 - cos( alpha * (PI/180.0) ) ) - (temp[2] * sin( alpha * (PI/180.0) ) );
	m[0][2] = (temp[0] * temp[2]) * ( 1 - cos( alpha * (PI/180.0) ) ) + (temp[1] * sin( alpha * (PI/180.0) ) );
	m[1][0] = (temp[0] * temp[1]) * ( 1 - cos( alpha * (PI/180.0) ) ) + (temp[2] * sin( alpha * (PI/180.0) ) );
	m[1][1] = temp[1] * temp[1] * ( 1 - cos( alpha * (PI/180.0) ) ) + cos( alpha * (PI/180.0) );
	m[1][2] = (temp[1] * temp[2]) * ( 1 - cos( alpha * (PI/180.0) ) ) - (temp[0] * sin( alpha * (PI/180.0) ) );
	m[2][0] = (temp[0] * temp[2]) * ( 1 - cos( alpha * (PI/180.0) ) ) - (temp[1] * sin( alpha * (PI/180.0) ) );
	m[2][1] = (temp[1] * temp[2]) * ( 1 - cos( alpha * (PI/180.0) ) ) + (temp[0] * sin( alpha * (PI/180.0) ) );
	m[2][2] = temp[2] * temp[2] * ( 1 - cos( alpha * (PI/180.0) ) ) + cos( alpha * (PI/180.0) );	
